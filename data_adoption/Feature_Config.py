...
FEATURE_TRAIN_FILE_NAME = "forecasting_features_train.pkl"
PROCESSED_FEATURE_TRAIN_FILE_NAME = "processed_forecasting_features_train.pt"

FEATURE_COLUMNS_MASTER_THESIS = [
    "TIMESTAMP",
    "TRACK_ID",
    "OBJECT_TYPE",
    "X",
...
""" Dropped NUM_NEIGHBORS """
FEATURE_FORMAT_MASTER_THESIS = {
    "TIMESTAMP": 0,
    "TRACK_ID": 1,
    "OBJECT_TYPE": 2,
    "X": 3,
    ...
    "CITY_NAME": 5,
    "ADJACENCY_NUM": 6,
    "OFFSET_FROM_CENTERLINE": 7,
    "DISTANCE_ALONG_CENTERLINE": 8,
    "MIN_DISTANCE_FRONT": 9,
    "MIN_DISTANCE_BACK": 10,
}
...
BASELINE_OUTPUT_FEATURES = {
    "master_thesis": ["OFFSET_FROM_CENTERLINE", "DISTANCE_ALONG_CENTERLINE"],
    "social": ["X", "Y"],
    "map": ["OFFSET_FROM_CENTERLINE", "DISTANCE_ALONG_CENTERLINE"],
